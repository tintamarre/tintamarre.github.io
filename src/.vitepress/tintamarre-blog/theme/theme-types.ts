...
export interface TintamarreBlogFeedConfig {
  /**
   * baseUrl
   *
...
export interface TintamarreBlogConfig {
  /**
...
export interface TintamarreBlogThemeConfig extends DefaultTheme.Config {
  /**
   * Config options related to the blog
   *
   */
  blog?: TintamarreBlogConfig
}
