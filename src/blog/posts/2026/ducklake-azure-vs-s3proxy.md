...
The architectural cost is one extra container in your stack. The performance win — especially on warm reads — is large enough that we're moving our CFWB DuckLake to this configuration.
